...
document.getElementById("continueBtn").addEventListener("click", function () {
    ...
    let deliveryName = document.getElementById("deliveryName").value.trim();

    let deliveryAddress = document.getElementById("deliveryAddress").value.trim();

    let deliveryPincode = document.getElementById("deliveryPincode").value.trim();

    let deliveryMobile = document.getElementById("deliveryMobile").value.trim();
