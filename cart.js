...
function displayCart() {
    ...
    cart.forEach(function(product, index) {
        ...
        productBox.innerHTML = `
            ...
            <div>
                ...
                <br><br>
                <span class="remove-product" data-index="${index}"  style="cursor:pointer;">
                    ✕ REMOVE
                </span>
            </div>  `;
    ...
    let finalTotal =  totalPrice -  totalDiscount +  deliveryCharge;
    ...
    let discountMessage = document.querySelector(".image-total span span");


    if (discountMessage) {

        discountMessage.textContent =  "₹" + totalDiscount;
