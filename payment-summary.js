...
if (!buyNowProduct) {
    ...
    let price =  Number(buyNowProduct.price) || 0;
    ...
    let finalPrice =  Math.max(price - discount, 0);
    ...
    document.getElementById("discountMessage") .textContent = "₹" + discount;


    // CASH ON DELIVERY

    document.getElementById("codPrice")  .textContent =  "₹" + finalPrice;


    // ONLINE PRICE

    document.getElementById("onlineOldPrice") .textContent =  "₹" + finalPrice;


    let onlinePrice =  Math.max(finalPrice - 24, 0);
