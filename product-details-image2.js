...
let suggestionBox = document.getElementById("searhSuggestions");
...
function showSuggestionBox() {
    ...
    suggestionBox.style.left = position.left + window.scrollX + "px";

    suggestionBox.style.top = position.bottom + window.scrollY + "px";
...
function filterProducts(searchText) {
    ...
    products.forEach(function (product) {
        ...
        let name = product.querySelector(".suggestion p");

        if (name) {
            productName =  name.textContent.toLowerCase();
        }
        ...
        // Exact word match
        let matched = words.some(function (word) {
...
if (searchBar && suggestionBox) {
    ...
    searchBar.addEventListener("input", function () {
        ...
        let result = suggestions.filter(function (item) {
        ...
        result.forEach(function (item) {
            ...
            div.addEventListener("click", function () {
                ...
                // IMPORTANT:
                // Use selected item
                let selectedText = item.toLowerCase().trim();
        ...
        if (result.length === 0) {
            ...
            suggestionBox.innerHTML = ` <div class="search-suggestion no-result"> No suggestion found </div> `;
...
let savedNumber = localStorage.getItem("mobileNumber");
    ...
    if (profileUser) {
        ...
        profileUser.textContent = savedNumber;
    ...
    if (profileMessage) {
        ...
        profileMessage.textContent = "Welcome to your Meesho account";
...
let productName = document.querySelector(".price-details p").textContent.trim();

let priceText = document.querySelector(".price").textContent.trim();

let productPrice = Number(priceText.replace(/[^\d]/g, ""));

let productImage = document.querySelector(".product-image img").src;
...
sizeButtons.forEach(function (button) {
    ...
    button.addEventListener("click", function () {
        ...
        // Ella size button-ஐ reset பண்ணும்
        sizeButtons.forEach(function (btn) {

            btn.style.backgroundColor = "rgba(168, 5, 168, 0.121)";
...
addToCartButton.addEventListener("click", function () {
    ...
    // --------------------------------------
    // after show the popup 
    // button changed in Go to Cart 
    // --------------------------------------
