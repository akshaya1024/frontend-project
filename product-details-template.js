...
// ==========================================
    ...
    document.getElementById("productRating").innerHTML = rating + ' <i class="fa-solid fa-star"></i>';
    ...
    document.getElementById("productReviews").textContent = "Ratings, " + reviews + " Reviews";
    ...
    document.getElementById("sellerMobile").textContent = product.sellerMobile || "-";

    document.getElementById("sellerEmail").textContent = product.sellerEmail || "-";

    document.getElementById("sellerAddress").textContent = (product.sellerAddress || "-") 

    // ==========================================
    // SIZE BUTTONS
    // ==========================================

    let sizeContainer = document.getElementById("sizeButtons");
    ...
    addToCartButton.addEventListener("click", function () {
        ...
        if (selectedSize === "") {
            ...
            cartToast.textContent = "Please select a size";
        ...
        cartToast.textContent = "Product is added to cart.";
        ...
        setTimeout(function () {
            ...
            addToCartButton.innerHTML = '<i class="fa-solid fa-cart-shopping"></i> Go to Cart';
